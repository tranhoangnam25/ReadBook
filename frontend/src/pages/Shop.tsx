            ...
            <header className="flex justify-between items-center px-8 py-4 border-b bg-[#F5F3EF]">
                <div className="flex items-center gap-8">
                    ...
                    <nav className="flex gap-6 text-sm text-gray-600">
                        <a>Explore</a>
                        <a>My Library</a>
                        <a className="text-[#D4A5A5] border-b-2 border-[#D4A5A5] pb-1">Shop</a>
                    </nav>
                </div>
                {/* SEARCH */}
                <div className="flex items-center gap-3 w-[520px]">
                    ...
                    />
                    <button onClick={handleSearchClick} className="border px-3 py-1.5 text-sm rounded-md">Search</button>
                    <button className="text-sm">Login</button>
                    <button className="bg-[#2C3E50] text-white px-4 py-1.5 rounded-md text-sm">Sign Up</button>
                </div>
            </header>
