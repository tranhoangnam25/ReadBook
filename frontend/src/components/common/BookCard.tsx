    ...
    return (
        <div className="group flex flex-col gap-4">
            ...
            <div className="space-y-1">
                ...
                <p className="text-sm text-primary/60">{book.author.name}</p>
                <div className="flex items-center gap-1">
                    {renderStars(book.previewPercentage)}
                    <span className="ml-1 text-xs font-semibold text-primary/40">{book.previewPercentage}</span>
                </div>
            </div>
        </div>
    )
