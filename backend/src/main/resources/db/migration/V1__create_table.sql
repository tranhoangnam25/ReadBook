...
-- UNIQUE INDEXES
-- ============================================================
CREATE UNIQUE INDEX [uk_book_chapter]    ON [Chapters]         ([book_id], [chapter_number]);
...
ALTER TABLE [Chapters]
  ADD CONSTRAINT [fk_chapters_book] FOREIGN KEY ([book_id]) REFERENCES [Books] ([book_id]);
GO
...
ALTER TABLE [Orders]
  ADD CONSTRAINT [fk_orders_user] FOREIGN KEY ([user_id]) REFERENCES [Users] ([user_id]),
      CONSTRAINT [fk_orders_book] FOREIGN KEY ([book_id]) REFERENCES [Books] ([book_id]);
GO
...
ALTER TABLE [Collections]
  ADD CONSTRAINT [fk_collections_user] FOREIGN KEY ([user_id]) REFERENCES [Users] ([user_id]);
GO

ALTER TABLE [Collection_Items]
  ADD CONSTRAINT [fk_col_items_collection] FOREIGN KEY ([collection_id]) REFERENCES [Collections]  ([collection_id]) ON DELETE CASCADE,
      CONSTRAINT [fk_col_items_book]       FOREIGN KEY ([book_id])       REFERENCES [Books]         ([book_id]);
GO
